...
| Version           | 0.1.0                                     |
| Status            | Draft                                     |
| Author            | Arnaud Gbaguidi                           |
| Language          | English                                   |
| Last Updated      | 2026-07-25                                |
| Related Documents | [01_PRD.md](01_PRD.md), [02_SRS.md](02_SRS.md) |
...
| ------- | ---------- | ------------- | ---------------------- |
| 0.1.0   | 2026-07-25 | Mede Gbaguidi | Initial project vision |
...
### Phase 1 — Hardware Instrument

A standalone instrument with manual configuration, local indication, and no firmware dependency.

### Phase 2 — Intelligent Instrument
